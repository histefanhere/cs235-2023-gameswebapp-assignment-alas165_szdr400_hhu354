...
def test_user_initialization():
    ...
    assert repr(user1) != "<User shyamli>" # We changed this so usernames are cap sensitive.
...
def test_user_hash():
    ...
    user_set.add(user3)
    print(user_set)
    assert sorted(user_set) == [user3, user1, user2]
...
def test_user_lt():
    ...
    assert sorted(user_list) == [user3, user1, user2]
